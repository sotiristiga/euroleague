...
ivan=ivan.loc[(ivan.Against.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))&(ivan.Team.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))]

fatih=fatih.loc[(fatih.Against.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))&(fatih.Team.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))]
alonso=alonso.loc[(alonso.Against.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))&(alonso.Team.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))]
vitoria=vitoria.loc[(vitoria.Against.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))&(vitoria.Team.isin(['Olympiacos FC','AEK Athens','PAOK','Panathinaikos']))]
...
##### Points ######
points_bar=px.bar(all_coaches,x='Coach',y='Points per games',
